...
var maybeReactUseSyncExternalStore = React24["useSyncExternalStore"];
...
function useGlobalId(idOverride) {
  const [defaultId, setDefaultId] = React26.useState(idOverride);
...
var maybeReactUseId = React26["useId".toString()];
...
function getValidReactChildren(children2) {
  return React29.Children.toArray(children2).filter((child) => React29.isValidElement(child));
}
...
function useCurrentColorScheme(options) {
  ...
  const setMode = React36.useCallback((mode) => {
  ...
  const setColorScheme = React36.useCallback((value) => {
    if (!value) {
      setState((currentState) => {
        try {
  ...
  const handleMediaQuery = React36.useCallback((event) => {
  ...
  const mediaListener = React36.useRef(handleMediaQuery);
...
function createCssVarsProvider(options) {
  ...
  const ColorSchemeContext = React37.createContext(void 0);
  if (true) {
  ...
  function CssVarsProvider(props) {
    ...
    const ctx = React37.useContext(ColorSchemeContext);
    ...
    const element = (0, import_jsx_runtime12.jsxs)(React37.Fragment, {
      children: [shouldGenerateStyleSheet && (0, import_jsx_runtime12.jsxs)(React37.Fragment, {
...
var ButtonGroupContext = React44.createContext({});
if (true) {
...
var ButtonGroupButtonContext = React45.createContext(void 0);
if (true) {
...
var Button = React46.forwardRef(function Button2(inProps, ref) {
  ...
  const buttonGroupButtonContextPositionClassName = React46.useContext(ButtonGroupButtonContext_default);
...
@mui/private-theming/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-ZJYOBNEZ.js.map
